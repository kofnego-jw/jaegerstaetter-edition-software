...
import at.kulinz.jaegerstaetter.biography.service.PreviewBiographyService;
...
@RestController
@Profile("preview")
public class PreviewBiographyController implements BiographyControllerApi {

    @Autowired
    private PreviewBiographyService biographyService;
