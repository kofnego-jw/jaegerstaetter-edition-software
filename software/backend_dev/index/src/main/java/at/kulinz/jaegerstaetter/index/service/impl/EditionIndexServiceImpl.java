...
@Component
public class EditionIndexServiceImpl implements IndexService {

    private final IndexServiceImpl delegate;

    @Autowired
    public EditionIndexServiceImpl(JaegerstaetterConfig config) {
        this.delegate = new IndexServiceImpl(config.editionLuceneDir());
    }
