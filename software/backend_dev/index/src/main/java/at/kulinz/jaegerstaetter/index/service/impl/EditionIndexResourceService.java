...
@Component
public class EditionIndexResourceService implements IndexResourceService {

    private final IndexResourceServiceImpl delegate;

    @Autowired
    public EditionIndexResourceService(JaegerstaetterConfig config) {
        this.delegate = new IndexResourceServiceImpl(config.editionLuceneDir());
    }
