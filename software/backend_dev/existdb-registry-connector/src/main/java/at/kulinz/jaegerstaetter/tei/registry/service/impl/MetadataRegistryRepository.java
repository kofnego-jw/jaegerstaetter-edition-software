...
@Component
public class MetadataRegistryRepository implements RegistryRepository {

    private final RegistryRepositoryImpl delegate;

    @Autowired
    public MetadataRegistryRepository(ExistDBTeiNotVersionedRepository ingestRepository, ExistDBTeiRepository editionRepository, JaegerstaetterConfig config) {
