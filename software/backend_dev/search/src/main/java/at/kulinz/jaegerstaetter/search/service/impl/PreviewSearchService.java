...
@Component
public class PreviewSearchService implements SearchService {

    private final SearchServiceImpl delegate;

    public PreviewSearchService(JaegerstaetterConfig config) {
        this.delegate = new SearchServiceImpl(config.previewLuceneDir());
    }
